...
class StaticTableViewController: UITableViewController, PresentersProviderProtocol {
  ...
  var shouldSetNavBarTransparent: Bool { false }

  var viewWillAppearCallCount: Int { _viewWillAppearCallCount }
